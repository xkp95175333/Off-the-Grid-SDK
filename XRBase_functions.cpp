...
#include "XRBase_classes.hpp"
#include "XRBase_parameters.hpp"
...
bool UHeadMountedDisplayFunctionLibrary::GetControllerTransformForTime(class UObject* WorldContext, const int32 ControllerIndex, const class FName MotionSource, const struct FTimespan& Time, bool* bTimeWasUsed, struct FRotator* Orientation, struct FVector* Position, bool* bProvidedLinearVelocity, struct FVector* LinearVelocity, bool* bProvidedAngularVelocity, struct FVector* AngularVelocityAsAxisAndLength, bool* bProvidedLinearAcceleration, struct FVector* LinearAcceleration)
{
	static class UFunction* Func = nullptr;
...
bool UHeadMountedDisplayFunctionLibrary::GetControllerTransformForTime2(class UObject* WorldContext, const int32 ControllerIndex, const class FName MotionSource, const struct FTimespan& Time, bool* bTimeWasUsed, struct FRotator* Orientation, struct FVector* Position, bool* bProvidedLinearVelocity, struct FVector* LinearVelocity, bool* bProvidedAngularVelocity, struct FRotator* AngularVelocity, bool* bProvidedLinearAcceleration, struct FVector* LinearAcceleration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("HeadMountedDisplayFunctionLibrary", "GetControllerTransformForTime2");

	Params::HeadMountedDisplayFunctionLibrary_GetControllerTransformForTime2 Parms{};
...
// struct FLinearColor                     ColorBias                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UHeadMountedDisplayFunctionLibrary::SetHMDColorScaleAndBias(const struct FLinearColor& ColorScale, const struct FLinearColor& ColorBias)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("HeadMountedDisplayFunctionLibrary", "SetHMDColorScaleAndBias");

	Params::HeadMountedDisplayFunctionLibrary_SetHMDColorScaleAndBias Parms{};

	Parms.ColorScale = std::move(ColorScale);
	Parms.ColorBias = std::move(ColorBias);
...
// DelegateFunction XRBase.VRNotificationsComponent.VRNotificationsDelegate__DelegateSignature
...
void UXRDeviceVisualizationComponent::SetCustomDisplayMesh(class UStaticMesh* NewDisplayMesh)
{
	...
	Params::XRDeviceVisualizationComponent_SetCustomDisplayMesh Parms{};
...
void UXRDeviceVisualizationComponent::SetDisplayModelSource(const class FName NewDisplayModelSource)
{
	static class UFunction* Func = nullptr;
	...
	Params::XRDeviceVisualizationComponent_SetDisplayModelSource Parms{};
...
void UXRDeviceVisualizationComponent::SetIsRenderingActive(bool bRenderingIsActive)
{
	...
	Params::XRDeviceVisualizationComponent_SetIsRenderingActive Parms{};
...
void UXRDeviceVisualizationComponent::SetIsVisualizationActive(bool bNewVisualizationState)
{
	...
	Params::XRDeviceVisualizationComponent_SetIsVisualizationActive Parms{};
