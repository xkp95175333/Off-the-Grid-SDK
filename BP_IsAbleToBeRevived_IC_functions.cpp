...
#include "BP_IsAbleToBeRevived_IC_classes.hpp"
#include "BP_IsAbleToBeRevived_IC_parameters.hpp"
...
bool UBP_IsAbleToBeRevived_IC_C::IsInteractionConditionPassed(const class AGzCharacter* InteractedBy, const class AActor* InteractableOwner)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_IsAbleToBeRevived_IC_C", "IsInteractionConditionPassed");

	Params::BP_IsAbleToBeRevived_IC_C_IsInteractionConditionPassed Parms{};
