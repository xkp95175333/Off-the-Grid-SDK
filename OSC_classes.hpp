...
{
public:
	uint8                                         Pad_47F5[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static class UOSCClient* CreateOSCClient(const class FString& SendIPAddress, int32 Port, const class FString& ClientName, class UObject* Param_Outer);
	static class UOSCServer* CreateOSCServer(const class FString& ReceiveIPAddress, int32 Port, bool bMulticastLoopback, bool bStartListening, const class FString& ServerName, class UObject* Param_Outer);
	static class UObject* FindObjectAtOSCAddress(const struct FOSCAddress& Address);
	static bool GetAddress(const struct FOSCMessage& Message, const int32 Param_Index, struct FOSCAddress* Value);
	...
	static bool GetBlob(const struct FOSCMessage& Message, const int32 Param_Index, TArray<uint8>* Value);
	static bool GetBool(const struct FOSCMessage& Message, const int32 Param_Index, bool* Value);
	static TArray<struct FOSCBundle> GetBundlesFromBundle(const struct FOSCBundle& Bundle);
	static bool GetFloat(const struct FOSCMessage& Message, const int32 Param_Index, float* Value);
	static bool GetInt32(const struct FOSCMessage& Message, const int32 Param_Index, int32* Value);
	static bool GetInt64(const struct FOSCMessage& Message, const int32 Param_Index, int64* Value);
	static struct FOSCMessage GetMessageFromBundle(const struct FOSCBundle& Bundle, int32 Param_Index, bool* bSucceeded);
	static TArray<struct FOSCMessage> GetMessagesFromBundle(const struct FOSCBundle& Bundle);
	static class FString GetOSCAddressContainer(const struct FOSCAddress& Address, const int32 Param_Index);
	...
	static bool GetString(const struct FOSCMessage& Message, const int32 Param_Index, class FString* Value);
	...
	static struct FOSCAddress OSCAddressRemoveContainers(struct FOSCAddress& Address, int32 Param_Index, int32 Count);
...
class UOSCServer final : public UObject
{
public:
	...
	uint8                                         Pad_480E[0x18];                                    // 0x0038(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_480F[0x80];                                    // 0x0060(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UOSCServer) == 0x000008, "Wrong alignment on UOSCServer");
