...
public:
	...
	uint8                                         Pad_2A09[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2A0A[0x28];                                    // 0x0040(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FLiveLinkInstanceProxy, PoseNode) == 0x000738, "Member 'FLiveLinkInstanceProxy::PoseNode' has a wrong offset!");
