...
public:
	...
	uint8                                         Pad_4A16[0x2];                                     // 0x0046(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A17[0x1];                                     // 0x00A3(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A18[0x2];                                     // 0x00AE(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UGLTFExportOptions, bExportVertexColors) == 0x00009C, "Member 'UGLTFExportOptions::bExportVertexColors' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportVertexSkinWeights) == 0x00009D, "Member 'UGLTFExportOptions::bExportVertexSkinWeights' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bMakeSkinnedMeshesRoot) == 0x00009E, "Member 'UGLTFExportOptions::bMakeSkinnedMeshesRoot' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bUseMeshQuantization) == 0x00009F, "Member 'UGLTFExportOptions::bUseMeshQuantization' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportLevelSequences) == 0x0000A0, "Member 'UGLTFExportOptions::bExportLevelSequences' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportAnimationSequences) == 0x0000A1, "Member 'UGLTFExportOptions::bExportAnimationSequences' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, TextureImageFormat) == 0x0000A2, "Member 'UGLTFExportOptions::TextureImageFormat' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4A1A[0x2];                                     // 0x002A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A1B[0x6];                                     // 0x003A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
