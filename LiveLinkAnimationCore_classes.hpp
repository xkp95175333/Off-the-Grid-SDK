...
static_assert(offsetof(ULiveLinkInstance, CurrentRetargetAsset) == 0x000368, "Member 'ULiveLinkInstance::CurrentRetargetAsset' has a wrong offset!");
...
{
public:
	uint8                                         Pad_2A0B[0xA0];                                    // 0x0028(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
