...
public:
	...
	uint8                                         Pad_3E55[0x7];                                     // 0x0039(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3E57[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E58[0x7];                                     // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<int32, class UTexture*>                  Textures;                                          // 0x0078(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3E59[0x40];                                    // 0x00C8(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOpenColorIOColorTransform) == 0x000108, "Wrong size on UOpenColorIOColorTransform");
...
public:
	...
	TArray<class UOpenColorIOColorTransform*>     ColorTransforms;                                   // 0x00A8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3E5A[0x30];                                    // 0x00B8(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOpenColorIOConfiguration) == 0x0000F8, "Wrong size on UOpenColorIOConfiguration");
...
static_assert(offsetof(UOpenColorIOConfiguration, Context) == 0x000058, "Member 'UOpenColorIOConfiguration::Context' has a wrong offset!");
static_assert(offsetof(UOpenColorIOConfiguration, ColorTransforms) == 0x0000A8, "Member 'UOpenColorIOConfiguration::ColorTransforms' has a wrong offset!");
static_assert(offsetof(UOpenColorIOConfiguration, ConfigHash) == 0x0000E8, "Member 'UOpenColorIOConfiguration::ConfigHash' has a wrong offset!");
...
{
public:
	uint8                                         Pad_3E5B[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
