...
{
public:
	uint8                                         Pad_167A[0x20];                                    // 0x0028(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_167B[0x20];                                    // 0x0060(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_167C[0x10];                                    // 0x0098(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_167D[0x20];                                    // 0x0098(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_167E[0x7];                                     // 0x00B9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_167F[0x28];                                    // 0x0060(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1680[0x7];                                     // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
