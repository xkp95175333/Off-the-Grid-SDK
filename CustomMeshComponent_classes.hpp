...
{
public:
	uint8                                         Pad_4D54[0x18];                                    // 0x0558(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCustomMeshComponent) == 0x000570, "Wrong size on UCustomMeshComponent");
