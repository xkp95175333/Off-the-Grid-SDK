...
public:
	...
	uint8                                         Pad_499A[0x3];                                     // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_499B[0x3];                                     // 0x0009(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(alignof(ChaosCacheManager_SetCurrentTime) == 0x000004, "Wrong alignment on ChaosCacheManager_SetCurrentTime");
static_assert(sizeof(ChaosCacheManager_SetCurrentTime) == 0x000004, "Wrong size on ChaosCacheManager_SetCurrentTime");
static_assert(offsetof(ChaosCacheManager_SetCurrentTime, CurrentTime) == 0x000000, "Member 'ChaosCacheManager_SetCurrentTime::CurrentTime' has a wrong offset!");
