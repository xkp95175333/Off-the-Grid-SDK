...
public:
	...
	uint8                                         Pad_3680[0x4];                                     // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_3681[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3682[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FQosRegionInfo) == 0x000008, "Wrong alignment on FQosRegionInfo");
static_assert(sizeof(FQosRegionInfo) == 0x000038, "Wrong size on FQosRegionInfo");
static_assert(offsetof(FQosRegionInfo, DisplayName) == 0x000000, "Member 'FQosRegionInfo::DisplayName' has a wrong offset!");
static_assert(offsetof(FQosRegionInfo, RegionId) == 0x000010, "Member 'FQosRegionInfo::RegionId' has a wrong offset!");
static_assert(offsetof(FQosRegionInfo, bEnabled) == 0x000020, "Member 'FQosRegionInfo::bEnabled' has a wrong offset!");
static_assert(offsetof(FQosRegionInfo, bVisible) == 0x000021, "Member 'FQosRegionInfo::bVisible' has a wrong offset!");
static_assert(offsetof(FQosRegionInfo, bAutoAssignable) == 0x000022, "Member 'FQosRegionInfo::bAutoAssignable' has a wrong offset!");
static_assert(offsetof(FQosRegionInfo, bAllowSubspaceBias) == 0x000023, "Member 'FQosRegionInfo::bAllowSubspaceBias' has a wrong offset!");
static_assert(offsetof(FQosRegionInfo, SubspaceBiasParams) == 0x000024, "Member 'FQosRegionInfo::SubspaceBiasParams' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3683[0x3];                                     // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3684[0x8];                                     // 0x0050(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3685[0x7];                                     // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FRegionQosInstance, DatacenterOptions) == 0x000038, "Member 'FRegionQosInstance::DatacenterOptions' has a wrong offset!");
