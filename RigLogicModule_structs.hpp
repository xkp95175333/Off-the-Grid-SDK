...
public:
	...
	uint8                                         Pad_3E4C[0x3C];                                    // 0x0024(0x003C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_3E4D[0x18];                                    // 0x0008(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E4E[0x4];                                     // 0x0094(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	struct FRigUnit_RigLogic_Data                 Data;                                              // 0x01D0(0x0098)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	bool                                          bIsInitialized;                                    // 0x0268(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3E4F[0x7];                                     // 0x0269(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_RigLogic) == 0x000010, "Wrong alignment on FRigUnit_RigLogic");
static_assert(sizeof(FRigUnit_RigLogic) == 0x000270, "Wrong size on FRigUnit_RigLogic");
static_assert(offsetof(FRigUnit_RigLogic, Data) == 0x0001D0, "Member 'FRigUnit_RigLogic::Data' has a wrong offset!");
static_assert(offsetof(FRigUnit_RigLogic, bIsInitialized) == 0x000268, "Member 'FRigUnit_RigLogic::bIsInitialized' has a wrong offset!");
