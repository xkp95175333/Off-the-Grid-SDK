...
{
public:
	uint8                                         Pad_3CFD[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3CFE[0x10];                                    // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3CFF[0x57];                                    // 0x0039(0x0057)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
