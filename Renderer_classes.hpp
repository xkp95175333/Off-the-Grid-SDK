...
{
public:
	class USparseVolumeTexture*                   SparseVolumeTexturePreview;                        // 0x0520(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_149D[0x3];                                     // 0x0531(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_149E[0x3];                                     // 0x0539(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_149F[0x1C];                                    // 0x0544(0x001C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USparseVolumeTextureViewerComponent) == 0x000560, "Wrong size on USparseVolumeTextureViewerComponent");
static_assert(offsetof(USparseVolumeTextureViewerComponent, SparseVolumeTexturePreview) == 0x000520, "Member 'USparseVolumeTextureViewerComponent::SparseVolumeTexturePreview' has a wrong offset!");
static_assert(offsetof(USparseVolumeTextureViewerComponent, Frame) == 0x000528, "Member 'USparseVolumeTextureViewerComponent::Frame' has a wrong offset!");
static_assert(offsetof(USparseVolumeTextureViewerComponent, FrameRate) == 0x00052C, "Member 'USparseVolumeTextureViewerComponent::FrameRate' has a wrong offset!");
static_assert(offsetof(USparseVolumeTextureViewerComponent, VoxelSize) == 0x000534, "Member 'USparseVolumeTextureViewerComponent::VoxelSize' has a wrong offset!");
static_assert(offsetof(USparseVolumeTextureViewerComponent, PreviewAttribute) == 0x000538, "Member 'USparseVolumeTextureViewerComponent::PreviewAttribute' has a wrong offset!");
static_assert(offsetof(USparseVolumeTextureViewerComponent, MipLevel) == 0x00053C, "Member 'USparseVolumeTextureViewerComponent::MipLevel' has a wrong offset!");
static_assert(offsetof(USparseVolumeTextureViewerComponent, Extinction) == 0x000540, "Member 'USparseVolumeTextureViewerComponent::Extinction' has a wrong offset!");
