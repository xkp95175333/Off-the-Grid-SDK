...
public:
	...
	uint8                                         Pad_4997[0x2];                                     // 0x02AA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4998[0x8];                                     // 0x02B0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FObservedComponent>             ObservedComponents;                                // 0x02B8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_4999[0x88];                                    // 0x02C8(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AChaosCacheManager) == 0x000350, "Wrong size on AChaosCacheManager");
...
static_assert(sizeof(AChaosCachePlayer) == 0x000350, "Wrong size on AChaosCachePlayer");
...
public:
	...
	uint8                                         Pad_499C[0x3];                                     // 0x01A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_499D[0x4];                                     // 0x01AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_499E[0x7C];                                    // 0x02E4(0x007C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_499F[0x8];                                     // 0x0098(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
