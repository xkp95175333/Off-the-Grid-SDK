...
{
public:
	class UGroomComponent*                        GroomComponent;                                    // 0x02A0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AGroomActor) == 0x0002A8, "Wrong size on AGroomActor");
static_assert(offsetof(AGroomActor, GroomComponent) == 0x0002A0, "Member 'AGroomActor::GroomComponent' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1D89[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D8A[0x3];                                     // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D8B[0x5];                                     // 0x00BB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D8C[0x3];                                     // 0x00DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 EffectiveLODBias;                                  // 0x00E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D8D[0x20];                                    // 0x00F0(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D8E[0x8];                                     // 0x0120(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D8F[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D90[0x40];                                    // 0x0070(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1D99[0x18];                                    // 0x0028(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D9A[0x10];                                    // 0x0078(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1D9B[0x10];                                    // 0x0558(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UGroomAsset*                            GroomAsset;                                        // 0x0568(0x0008)(Edit, BlueprintVisible, ZeroConstructor, Interp, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGroomCache*                            GroomCache;                                        // 0x0570(0x0008)(Edit, BlueprintVisible, ZeroConstructor, Interp, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UNiagaraComponent*>              NiagaraComponents;                                 // 0x0578(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
	class USkeletalMesh*                          SourceSkeletalMesh;                                // 0x0588(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGroomBindingAsset*                     BindingAsset;                                      // 0x0590(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Interp, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPhysicsAsset*                          PhysicsAsset;                                      // 0x0598(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D9C[0x10];                                    // 0x05A0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHairSimulationSettings                SimulationSettings;                                // 0x05B0(0x0090)(Edit, BlueprintVisible, Interp, NativeAccessSpecifierPublic)
	class UMeshDeformer*                          MeshDeformer;                                      // 0x0640(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshDeformerInstance*                  MeshDeformerInstance;                              // 0x0648(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMeshDeformerInstanceSettings*          MeshDeformerInstanceSettings;                      // 0x0650(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Strands_DebugMaterial;                             // 0x0658(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Strands_DefaultMaterial;                           // 0x0660(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Cards_DefaultMaterial;                             // 0x0668(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     Meshes_DefaultMaterial;                            // 0x0670(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         AngularSpringsSystem;                              // 0x0678(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNiagaraSystem*                         CosseratRodsSystem;                                // 0x0680(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AttachmentName;                                    // 0x0688(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Interp, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D9D[0x88];                                    // 0x0698(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FHairGroupDesc>                 GroomGroupsDesc;                                   // 0x0720(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bUseCards;                                         // 0x0730(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRunning;                                          // 0x0731(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bLooping;                                          // 0x0732(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bManualTick;                                       // 0x0733(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         ElapsedTime;                                       // 0x0734(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D9E[0x68];                                    // 0x0738(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGroomComponent) == 0x0007A0, "Wrong size on UGroomComponent");
static_assert(offsetof(UGroomComponent, GroomAsset) == 0x000568, "Member 'UGroomComponent::GroomAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, GroomCache) == 0x000570, "Member 'UGroomComponent::GroomCache' has a wrong offset!");
static_assert(offsetof(UGroomComponent, NiagaraComponents) == 0x000578, "Member 'UGroomComponent::NiagaraComponents' has a wrong offset!");
static_assert(offsetof(UGroomComponent, SourceSkeletalMesh) == 0x000588, "Member 'UGroomComponent::SourceSkeletalMesh' has a wrong offset!");
static_assert(offsetof(UGroomComponent, BindingAsset) == 0x000590, "Member 'UGroomComponent::BindingAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, PhysicsAsset) == 0x000598, "Member 'UGroomComponent::PhysicsAsset' has a wrong offset!");
static_assert(offsetof(UGroomComponent, SimulationSettings) == 0x0005B0, "Member 'UGroomComponent::SimulationSettings' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformer) == 0x000640, "Member 'UGroomComponent::MeshDeformer' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformerInstance) == 0x000648, "Member 'UGroomComponent::MeshDeformerInstance' has a wrong offset!");
static_assert(offsetof(UGroomComponent, MeshDeformerInstanceSettings) == 0x000650, "Member 'UGroomComponent::MeshDeformerInstanceSettings' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Strands_DebugMaterial) == 0x000658, "Member 'UGroomComponent::Strands_DebugMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Strands_DefaultMaterial) == 0x000660, "Member 'UGroomComponent::Strands_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Cards_DefaultMaterial) == 0x000668, "Member 'UGroomComponent::Cards_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, Meshes_DefaultMaterial) == 0x000670, "Member 'UGroomComponent::Meshes_DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AngularSpringsSystem) == 0x000678, "Member 'UGroomComponent::AngularSpringsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, CosseratRodsSystem) == 0x000680, "Member 'UGroomComponent::CosseratRodsSystem' has a wrong offset!");
static_assert(offsetof(UGroomComponent, AttachmentName) == 0x000688, "Member 'UGroomComponent::AttachmentName' has a wrong offset!");
static_assert(offsetof(UGroomComponent, GroomGroupsDesc) == 0x000720, "Member 'UGroomComponent::GroomGroupsDesc' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bUseCards) == 0x000730, "Member 'UGroomComponent::bUseCards' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bRunning) == 0x000731, "Member 'UGroomComponent::bRunning' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bLooping) == 0x000732, "Member 'UGroomComponent::bLooping' has a wrong offset!");
static_assert(offsetof(UGroomComponent, bManualTick) == 0x000733, "Member 'UGroomComponent::bManualTick' has a wrong offset!");
static_assert(offsetof(UGroomComponent, ElapsedTime) == 0x000734, "Member 'UGroomComponent::ElapsedTime' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1DA0[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1DA1[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1DA2[0x3];                                     // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1DA3[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1DA4[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1DA5[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1DA6[0x8];                                     // 0x0098(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1DA7[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1DA8[0x8];                                     // 0x0050(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1DA9[0x4];                                     // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
