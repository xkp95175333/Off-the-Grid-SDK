...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0BC56C30;
	constexpr int32 AppendString      = 0x0155C8F0;
	constexpr int32 GNames            = 0x0BB9F800;
	constexpr int32 GWorld            = 0x0BDDB548;
	constexpr int32 ProcessEvent      = 0x017691D0;
...
public:
	...
	uint8                                         Pad_2[0x8];                                        // 0x0008(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
