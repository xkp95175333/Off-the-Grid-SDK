...
{
public:
	TArray<TSubclassOf<class UARComponent>>       ARComponentClasses;                                // 0x02A0(0x0010)(Edit, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UPassthroughMaterialUpdateComponent*    PassthroughUpdateComponent;                        // 0x02B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AARPassthroughManager) == 0x0002B8, "Wrong size on AARPassthroughManager");
static_assert(offsetof(AARPassthroughManager, ARComponentClasses) == 0x0002A0, "Member 'AARPassthroughManager::ARComponentClasses' has a wrong offset!");
static_assert(offsetof(AARPassthroughManager, PassthroughUpdateComponent) == 0x0002B0, "Member 'AARPassthroughManager::PassthroughUpdateComponent' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4646[0x7];                                     // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
