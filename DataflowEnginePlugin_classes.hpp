...
static_assert(sizeof(ADataflowActor) == 0x0002A8, "Wrong size on ADataflowActor");
static_assert(offsetof(ADataflowActor, DataflowComponent) == 0x0002A0, "Member 'ADataflowActor::DataflowComponent' has a wrong offset!");
...
{
public:
	uint8                                         Pad_4BA4[0x140];                                   // 0x0520(0x0140)(Fixing Struct Size After Last Property [ Dumper-7 ])
