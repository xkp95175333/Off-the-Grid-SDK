...
{
public:
	uint8                                         Pad_36B8[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	TArray<struct FLobbyPlayerStateActorInfo>     Players;                                           // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class ALobbyBeaconState*                      ParentState;                                       // 0x0120(0x0008)(ZeroConstructor, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FLobbyPlayerStateInfoArray) == 0x000008, "Wrong alignment on FLobbyPlayerStateInfoArray");
static_assert(sizeof(FLobbyPlayerStateInfoArray) == 0x000128, "Wrong size on FLobbyPlayerStateInfoArray");
static_assert(offsetof(FLobbyPlayerStateInfoArray, Players) == 0x000110, "Member 'FLobbyPlayerStateInfoArray::Players' has a wrong offset!");
static_assert(offsetof(FLobbyPlayerStateInfoArray, ParentState) == 0x000120, "Member 'FLobbyPlayerStateInfoArray::ParentState' has a wrong offset!");
