...
public:
	...
	uint8                                         Pad_48F9[0x4];                                     // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(WebBrowser_OnUrlChanged__DelegateSignature) == 0x000010, "Wrong size on WebBrowser_OnUrlChanged__DelegateSignature");
...
static_assert(sizeof(WebBrowser_GetTitleText) == 0x000010, "Wrong size on WebBrowser_GetTitleText");
