...
public:
	...
	uint8                                         Pad_28D2[0x34];                                    // 0x0C1C(0x0034)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAudioCurveSourceComponent) == 0x000C50, "Wrong size on UAudioCurveSourceComponent");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSourceBindingName) == 0x000C10, "Member 'UAudioCurveSourceComponent::CurveSourceBindingName' has a wrong offset!");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSyncOffset) == 0x000C18, "Member 'UAudioCurveSourceComponent::CurveSyncOffset' has a wrong offset!");
