...
{
public:
	uint8                                         Pad_45C5[0x20];                                    // 0x0030(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_45C6[0x10];                                    // 0x0070(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailed;                                          // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_45C7[0x40];                                    // 0x0070(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FGuid                                  NativeID;                                          // 0x0230(0x0010)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45C8[0x30];                                    // 0x0240(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUseDefaultReplication;                            // 0x0270(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_45C9[0x7];                                     // 0x0271(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMaterialInterface*                     DefaultMeshMaterial;                               // 0x0278(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     DefaultWireframeMeshMaterial;                      // 0x0280(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMRMeshComponent*                       MRMeshComponent;                                   // 0x0288(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UARTrackedGeometry*                     MyTrackedGeometry;                                 // 0x0290(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_45CA[0x18];                                    // 0x0298(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UARComponent, NativeID) == 0x000230, "Member 'UARComponent::NativeID' has a wrong offset!");
static_assert(offsetof(UARComponent, bUseDefaultReplication) == 0x000270, "Member 'UARComponent::bUseDefaultReplication' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultMeshMaterial) == 0x000278, "Member 'UARComponent::DefaultMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultWireframeMeshMaterial) == 0x000280, "Member 'UARComponent::DefaultWireframeMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, MRMeshComponent) == 0x000288, "Member 'UARComponent::MRMeshComponent' has a wrong offset!");
static_assert(offsetof(UARComponent, MyTrackedGeometry) == 0x000290, "Member 'UARComponent::MyTrackedGeometry' has a wrong offset!");
...
{
public:
	struct FARPlaneUpdatePayload                  ReplicatedPayload;                                 // 0x02B0(0x00D0)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARPlaneComponent) == 0x000380, "Wrong size on UARPlaneComponent");
...
{
public:
	struct FARPointUpdatePayload                  ReplicatedPayload;                                 // 0x02B0(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_45CB[0xF];                                     // 0x02B1(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UARPointComponent) == 0x0002C0, "Wrong size on UARPointComponent");
static_assert(offsetof(UARPointComponent, ReplicatedPayload) == 0x0002B0, "Member 'UARPointComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	EARFaceTransformMixing                        TransformSetting;                                  // 0x02B0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUpdateVertexNormal;                               // 0x02B1(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bFaceOutOfScreen;                                  // 0x02B2(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_45CC[0x5];                                     // 0x02B3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FARFaceUpdatePayload                   ReplicatedPayload;                                 // 0x02B8(0x0060)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_45CD[0x28];                                    // 0x0318(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UARFaceComponent) == 0x000340, "Wrong size on UARFaceComponent");
static_assert(offsetof(UARFaceComponent, TransformSetting) == 0x0002B0, "Member 'UARFaceComponent::TransformSetting' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bUpdateVertexNormal) == 0x0002B1, "Member 'UARFaceComponent::bUpdateVertexNormal' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bFaceOutOfScreen) == 0x0002B2, "Member 'UARFaceComponent::bFaceOutOfScreen' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, ReplicatedPayload) == 0x0002B8, "Member 'UARFaceComponent::ReplicatedPayload' has a wrong offset!");
...
{
public:
	struct FARImageUpdatePayload                  ReplicatedPayload;                                 // 0x02B0(0x00A0)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARImageComponent) == 0x000350, "Wrong size on UARImageComponent");
...
public:
	...
	uint8                                         Pad_45CE[0x2];                                     // 0x0046(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45CF[0x3];                                     // 0x005D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45D0[0x1];                                     // 0x008F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45D1[0x4];                                     // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45D2[0x6];                                     // 0x00AA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void RemoveCandidateImageAtIndex(int32 Param_Index);
...
{
public:
	struct FARQRCodeUpdatePayload                 ReplicatedPayload;                                 // 0x02B0(0x00B0)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARQRCodeComponent) == 0x000360, "Wrong size on UARQRCodeComponent");
...
{
public:
	struct FARPoseUpdatePayload                   ReplicatedPayload;                                 // 0x02B0(0x0070)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARPoseComponent) == 0x000320, "Wrong size on UARPoseComponent");
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailed;                                          // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_45D3[0x38];                                    // 0x0070(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FAREnvironmentProbeUpdatePayload       ReplicatedPayload;                                 // 0x02B0(0x0060)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAREnvironmentProbeComponent) == 0x000310, "Wrong size on UAREnvironmentProbeComponent");
...
{
public:
	struct FARObjectUpdatePayload                 ReplicatedPayload;                                 // 0x02B0(0x0060)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
{
public:
	struct FARMeshUpdatePayload                   ReplicatedPayload;                                 // 0x02B0(0x0090)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
{
public:
	struct FARGeoAnchorUpdatePayload              ReplicatedPayload;                                 // 0x02B0(0x00A0)(BlueprintVisible, BlueprintReadOnly, Net, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UARGeoAnchorComponent) == 0x000350, "Wrong size on UARGeoAnchorComponent");
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0050(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailed;                                          // 0x0060(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_45DB[0x30];                                    // 0x0070(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	FMulticastInlineDelegateProperty_             OnARActorSpawnedDelegate;                          // 0x0230(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnARActorToBeDestroyedDelegate;                    // 0x0240(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_45DD[0x10];                                    // 0x0250(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UARLifeCycleComponent, OnARActorSpawnedDelegate) == 0x000230, "Member 'UARLifeCycleComponent::OnARActorSpawnedDelegate' has a wrong offset!");
static_assert(offsetof(UARLifeCycleComponent, OnARActorToBeDestroyedDelegate) == 0x000240, "Member 'UARLifeCycleComponent::OnARActorToBeDestroyedDelegate' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_45DE[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45DF[0x1F];                                    // 0x0101(0x001F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45E0[0x10];                                    // 0x0140(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_45E1[0x64];                                    // 0x0384(0x0064)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSharedWorldGameMode) == 0x0003E8, "Wrong size on AARSharedWorldGameMode");
static_assert(offsetof(AARSharedWorldGameMode, BufferSizePerChunk) == 0x000380, "Member 'AARSharedWorldGameMode::BufferSizePerChunk' has a wrong offset!");
...
{
public:
	TArray<uint8>                                 PreviewImageData;                                  // 0x0318(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint8>                                 ARWorldData;                                       // 0x0328(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         PreviewImageBytesTotal;                            // 0x0338(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ARWorldBytesTotal;                                 // 0x033C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PreviewImageBytesDelivered;                        // 0x0340(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ARWorldBytesDelivered;                             // 0x0344(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45E2[0x8];                                     // 0x0348(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSharedWorldGameState) == 0x000350, "Wrong size on AARSharedWorldGameState");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageData) == 0x000318, "Member 'AARSharedWorldGameState::PreviewImageData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldData) == 0x000328, "Member 'AARSharedWorldGameState::ARWorldData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesTotal) == 0x000338, "Member 'AARSharedWorldGameState::PreviewImageBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesTotal) == 0x00033C, "Member 'AARSharedWorldGameState::ARWorldBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesDelivered) == 0x000340, "Member 'AARSharedWorldGameState::PreviewImageBytesDelivered' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesDelivered) == 0x000344, "Member 'AARSharedWorldGameState::ARWorldBytesDelivered' has a wrong offset!");
...
{
public:
	uint8                                         Pad_45E3[0x8];                                     // 0x0888(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSharedWorldPlayerController) == 0x000890, "Wrong size on AARSharedWorldPlayerController");
...
public:
	...
	uint8                                         Pad_45E6[0x8];                                     // 0x02B8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_45E7[0x3];                                     // 0x0139(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_45E8[0x5];                                     // 0x015B(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_45E9[0x3];                                     // 0x0141(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAREnvironmentCaptureProbeTexture) == 0x000160, "Wrong size on UAREnvironmentCaptureProbeTexture");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, TextureType) == 0x000140, "Member 'UAREnvironmentCaptureProbeTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Timestamp) == 0x000144, "Member 'UAREnvironmentCaptureProbeTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, ExternalTextureGuid) == 0x000148, "Member 'UAREnvironmentCaptureProbeTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Size) == 0x000158, "Member 'UAREnvironmentCaptureProbeTexture::Size' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_45EA[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45EB[0xF];                                     // 0x0101(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45EC[0x16];                                    // 0x011A(0x0016)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45ED[0xC];                                     // 0x0134(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45EE[0x10];                                    // 0x0148(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_45EF[0x7];                                     // 0x0159(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_45F0[0x8];                                     // 0x01A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_45F1[0xC];                                     // 0x0184(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_45F2[0x7];                                     // 0x0171(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<EARFaceBlendShape, float>                BlendShapes;                                       // 0x0178(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_45F3[0x38];                                    // 0x01C8(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
...
#pragma pack(push, 0x1)
class alignas(0x10) UAREnvironmentCaptureProbe : public UARTrackedGeometry
{
public:
...
public:
	...
	uint8                                         Pad_45F7[0x8];                                     // 0x01A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_45FA[0x18];                                    // 0x0158(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UARTrackableNotifyComponent) == 0x0001F8, "Wrong size on UARTrackableNotifyComponent");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedGeometry) == 0x0000A8, "Member 'UARTrackableNotifyComponent::OnAddTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedGeometry) == 0x0000B8, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedGeometry) == 0x0000C8, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedGeometry' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedPlane) == 0x0000D8, "Member 'UARTrackableNotifyComponent::OnAddTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedPlane) == 0x0000E8, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedPlane) == 0x0000F8, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedPlane' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedPoint) == 0x000108, "Member 'UARTrackableNotifyComponent::OnAddTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedPoint) == 0x000118, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedPoint) == 0x000128, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedPoint' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedImage) == 0x000138, "Member 'UARTrackableNotifyComponent::OnAddTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedImage) == 0x000148, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedImage) == 0x000158, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedImage' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedFace) == 0x000168, "Member 'UARTrackableNotifyComponent::OnAddTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedFace) == 0x000178, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedFace) == 0x000188, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedFace' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedEnvProbe) == 0x000198, "Member 'UARTrackableNotifyComponent::OnAddTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedEnvProbe) == 0x0001A8, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedEnvProbe) == 0x0001B8, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedEnvProbe' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnAddTrackedObject) == 0x0001C8, "Member 'UARTrackableNotifyComponent::OnAddTrackedObject' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnUpdateTrackedObject) == 0x0001D8, "Member 'UARTrackableNotifyComponent::OnUpdateTrackedObject' has a wrong offset!");
static_assert(offsetof(UARTrackableNotifyComponent, OnRemoveTrackedObject) == 0x0001E8, "Member 'UARTrackableNotifyComponent::OnRemoveTrackedObject' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_45FB[0x7];                                     // 0x0051(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
