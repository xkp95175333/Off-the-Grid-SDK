...
public:
	...
	uint8                                         Pad_5742[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5743[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimInstance*                          CallFunc_GetAnimInstance_ReturnValue;              // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class ILocomotionAnimationInterface> K2Node_DynamicCast_AsLocomotion_Animation_Interface; // 0x0058(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(OverlayOverride_NotifyState_C_Received_NotifyBegin, K2Node_DynamicCast_AsLocomotion_Animation_Interface) == 0x000058, "Member 'OverlayOverride_NotifyState_C_Received_NotifyBegin::K2Node_DynamicCast_AsLocomotion_Animation_Interface' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5744[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimInstance*                          CallFunc_GetAnimInstance_ReturnValue;              // 0x0048(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class ILocomotionAnimationInterface> K2Node_DynamicCast_AsLocomotion_Animation_Interface; // 0x0050(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(OverlayOverride_NotifyState_C_Received_NotifyEnd, K2Node_DynamicCast_AsLocomotion_Animation_Interface) == 0x000050, "Member 'OverlayOverride_NotifyState_C_Received_NotifyEnd::K2Node_DynamicCast_AsLocomotion_Animation_Interface' has a wrong offset!");
