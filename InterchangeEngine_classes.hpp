...
public:
	...
	uint8                                         Pad_4B4A[0x7];                                     // 0x0211(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_4B4B[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4B4C[0x48];                                    // 0x0090(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_4B4D[0x178];                                   // 0x0028(0x0178)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4B4E[0x70];                                    // 0x02E0(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
