...
static_assert(sizeof(GameSetting_GetDescriptionRichText) == 0x000010, "Wrong size on GameSetting_GetDescriptionRichText");
...
static_assert(sizeof(GameSetting_GetDisplayName) == 0x000010, "Wrong size on GameSetting_GetDisplayName");
...
static_assert(sizeof(GameSetting_GetDynamicDetails) == 0x000010, "Wrong size on GameSetting_GetDynamicDetails");
...
static_assert(sizeof(GameSetting_GetWarningRichText) == 0x000010, "Wrong size on GameSetting_GetWarningRichText");
...
static_assert(sizeof(GameSettingListEntrySetting_Action_OnSettingAssigned) == 0x000010, "Wrong size on GameSettingListEntrySetting_Action_OnSettingAssigned");
...
static_assert(sizeof(GameSettingListEntrySetting_Navigation_OnSettingAssigned) == 0x000010, "Wrong size on GameSettingListEntrySetting_Navigation_OnSettingAssigned");
...
// DelegateFunction GameSettings.GameSettingPanel.OnExecuteNamedActionBP__DelegateSignature
// 0x0010 (0x0010 - 0x0000)
struct GameSettingPanel_OnExecuteNamedActionBP__DelegateSignature final
{
public:
	...
	struct FGameplayTag                           Action;                                            // 0x0008(0x0008)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GameSettingPanel_OnExecuteNamedActionBP__DelegateSignature) == 0x000008, "Wrong alignment on GameSettingPanel_OnExecuteNamedActionBP__DelegateSignature");
static_assert(sizeof(GameSettingPanel_OnExecuteNamedActionBP__DelegateSignature) == 0x000010, "Wrong size on GameSettingPanel_OnExecuteNamedActionBP__DelegateSignature");
static_assert(offsetof(GameSettingPanel_OnExecuteNamedActionBP__DelegateSignature, Setting) == 0x000000, "Member 'GameSettingPanel_OnExecuteNamedActionBP__DelegateSignature::Setting' has a wrong offset!");
static_assert(offsetof(GameSettingPanel_OnExecuteNamedActionBP__DelegateSignature, Action) == 0x000008, "Member 'GameSettingPanel_OnExecuteNamedActionBP__DelegateSignature::Action' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2550[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
