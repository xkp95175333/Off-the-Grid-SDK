...
{
public:
	uint8                                         Pad_1474[0xE70];                                   // 0x0028(0x0E70)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAssetRegistryImpl) == 0x000E98, "Wrong size on UAssetRegistryImpl");
