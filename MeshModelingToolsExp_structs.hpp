...
public:
	...
	uint8                                         Pad_4BB5[0x4];                                     // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_4BB6[0xC];                                     // 0x0004(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4BB7[0x8];                                     // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4BB8[0x8];                                     // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             Transform;                                         // 0x0010(0x0060)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FKShapeElem                            Element;                                           // 0x0070(0x0030)(Edit, EditConst, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                         Pad_4BB9[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4BBA[0x8];                                     // 0x000C(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	class UTransformProxy*                        TransformProxy;                                    // 0x0000(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCombinedTransformGizmo*                TransformGizmo;                                    // 0x0008(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSet<class UObject*>                          Components;                                        // 0x0010(0x0050)(NativeAccessSpecifierPublic)
	struct FTransform                             BaseTransformForOffsetCalc;                        // 0x0060(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         InstanceId;                                        // 0x00C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4BBB[0xC];                                     // 0x00C4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTransformMeshesTarget) == 0x000010, "Wrong alignment on FTransformMeshesTarget");
static_assert(sizeof(FTransformMeshesTarget) == 0x0000D0, "Wrong size on FTransformMeshesTarget");
...
static_assert(offsetof(FTransformMeshesTarget, Components) == 0x000010, "Member 'FTransformMeshesTarget::Components' has a wrong offset!");
static_assert(offsetof(FTransformMeshesTarget, BaseTransformForOffsetCalc) == 0x000060, "Member 'FTransformMeshesTarget::BaseTransformForOffsetCalc' has a wrong offset!");
static_assert(offsetof(FTransformMeshesTarget, InstanceId) == 0x0000C0, "Member 'FTransformMeshesTarget::InstanceId' has a wrong offset!");
