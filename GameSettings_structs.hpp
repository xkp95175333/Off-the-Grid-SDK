...
public:
	...
	uint8                                         Pad_253E[0x37C];                                   // 0x0004(0x037C)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameSetting*>                   SettingRootList;                                   // 0x0380(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UGameSetting*>                   SettingAllowList;                                  // 0x0390(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FGameSettingFilterState) == 0x000008, "Wrong alignment on FGameSettingFilterState");
static_assert(sizeof(FGameSettingFilterState) == 0x0003A0, "Wrong size on FGameSettingFilterState");
...
static_assert(offsetof(FGameSettingFilterState, SettingRootList) == 0x000380, "Member 'FGameSettingFilterState::SettingRootList' has a wrong offset!");
static_assert(offsetof(FGameSettingFilterState, SettingAllowList) == 0x000390, "Member 'FGameSettingFilterState::SettingAllowList' has a wrong offset!");
