...
public:
	...
	uint8                                         Pad_255E[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(FMotionWarpingTarget, LocationOffset) == 0x000050, "Member 'FMotionWarpingTarget::LocationOffset' has a wrong offset!");
static_assert(offsetof(FMotionWarpingTarget, RotationOffset) == 0x000068, "Member 'FMotionWarpingTarget::RotationOffset' has a wrong offset!");
