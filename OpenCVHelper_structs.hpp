...
// Enum OpenCVHelper.EArucoDictionary
// NumValues: 0x0013
enum class EArucoDictionary : uint8
{
	...
	DICT_7X7_250                             = 15,
	DICT_7X7_1000                            = 16,
	DICT_ARUCO_ORIGINAL                      = 17,
	EArucoDictionary_MAX                     = 18,
};
...
public:
	...
	uint8                                         Pad_47A7[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FVector2D>                      Corners;                                           // 0x0008(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_47A8[0x8];                                     // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_47A9[0x7];                                     // 0x0041(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
