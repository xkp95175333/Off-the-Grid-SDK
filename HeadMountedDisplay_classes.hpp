...
public:
	...
	uint8                                         Pad_14AA[0x3];                                     // 0x052D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_14AB[0x12F];                                   // 0x0531(0x012F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMotionControllerComponent, PlayerIndex) == 0x000520, "Member 'UMotionControllerComponent::PlayerIndex' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, MotionSource) == 0x000524, "Member 'UMotionControllerComponent::MotionSource' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, CurrentTrackingStatus) == 0x000530, "Member 'UMotionControllerComponent::CurrentTrackingStatus' has a wrong offset!");
