...
public:
	...
	uint8                                         Pad_47B4[0x6];                                     // 0x0032(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47B5[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47B6[0x1C];                                    // 0x00FC(0x001C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UTextureRenderTarget2D*                 GarbageMatteMask;                                  // 0x02A0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMediaBundle*                           MediaBundle;                                       // 0x02A8(0x0008)(Edit, ZeroConstructor, NoClear, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAutoPlay;                                         // 0x02B0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPlayWhileEditing;                                 // 0x02B1(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_47B7[0x6];                                     // 0x02B2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UPrimitiveComponent*                    PrimitiveCmp;                                      // 0x02B8(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMediaSoundComponent*                   MediaSoundCmp;                                     // 0x02C0(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoClear, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               Material;                                          // 0x02C8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         PrimitiveMaterialIndex;                            // 0x02D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_47B8[0xC];                                     // 0x02D4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AMediaBundleActorBase) == 0x0002E0, "Wrong size on AMediaBundleActorBase");
static_assert(offsetof(AMediaBundleActorBase, GarbageMatteMask) == 0x0002A0, "Member 'AMediaBundleActorBase::GarbageMatteMask' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, MediaBundle) == 0x0002A8, "Member 'AMediaBundleActorBase::MediaBundle' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, bAutoPlay) == 0x0002B0, "Member 'AMediaBundleActorBase::bAutoPlay' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, bPlayWhileEditing) == 0x0002B1, "Member 'AMediaBundleActorBase::bPlayWhileEditing' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, PrimitiveCmp) == 0x0002B8, "Member 'AMediaBundleActorBase::PrimitiveCmp' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, MediaSoundCmp) == 0x0002C0, "Member 'AMediaBundleActorBase::MediaSoundCmp' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, Material) == 0x0002C8, "Member 'AMediaBundleActorBase::Material' has a wrong offset!");
static_assert(offsetof(AMediaBundleActorBase, PrimitiveMaterialIndex) == 0x0002D0, "Member 'AMediaBundleActorBase::PrimitiveMaterialIndex' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_47B9[0x28];                                    // 0x0038(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_47BA[0x28];                                    // 0x0040(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_47BB[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47BC[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47BD[0x8];                                     // 0x0068(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_47BE[0x8];                                     // 0x0080(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_47BF[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_47C0[0x8];                                     // 0x0040(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_47C1[0x8];                                     // 0x0090(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
